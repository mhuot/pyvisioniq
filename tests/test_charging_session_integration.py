...
def simulate_charging_session():
    ...
    data1 = {
        "battery": {"level": 65, "is_charging": True, "charging_power": 7.2, "range": 200},
        "location": {"latitude": 44.88585, "longitude": -93.13727},
        "temperature": 20,
        "odometer": 5000,
    }
    ...
    data2 = {
        "battery": {"level": 68, "is_charging": True, "charging_power": 7.2, "range": 210},
        "location": {"latitude": 44.88585, "longitude": -93.13727},
        "temperature": 20,
        "odometer": 5000,
    }
    ...
    data3 = {
        "battery": {"level": 70, "is_charging": False, "charging_power": 0, "range": 220},
        "location": {"latitude": 44.88585, "longitude": -93.13727},
        "temperature": 20,
        "odometer": 5000,
    }
